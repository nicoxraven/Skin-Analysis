...
import {
  ...
  Eye as EyeIcon, AlertTriangle, UserCircle, Phone,
} from "lucide-react";
...
export function LoginPage({ onLogin }) {
  ...
  const handleSubmit = (e) => {
    ...
    if (isRegister) {
      registerUser(name, email, password, phoneNumber, age, "user", "").then((res) => {
        ...
        <div className="w-full max-w-sm">
          <div className="flex items-center gap-4 mb-8">
            <button
              ...
              className="w-10 h-10 flex items-center justify-center rounded-xl bg-secondary text-muted-foreground hover:text-foreground transition-colors"
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {isRegister && (
              <div>
                <label className="text-sm font-medium text-foreground block mb-1.5">Phone Number (KBZ Pay)</label>
                <div className="relative">
